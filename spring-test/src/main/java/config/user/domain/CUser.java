...
public class CUser implements Serializable {
	...
	public String toString() {
		return "CUser [userId=" + userId + ", name=" + name + ", teamName=" + teamName + ", languageCode="
				+ languageCode + ", updatedAt=" + updatedAt + ", createdAt=" + createdAt + ", totalPayAmount="
				+ totalPayAmount + ", biLogJson=" + biLogJson + "]";
	}
